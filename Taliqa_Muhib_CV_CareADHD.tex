...
\begin{itemize}
  ...
  \item \textbf{Data \& BI:} SQL, SQL Server, MySQL, PostgreSQL, Tableau, Power BI, Excel,
        Dashboards, KPI Reporting, Data Quality Checks
  \item \textbf{Cloud, ETL \& Tools:} Azure Data Factory, AWS, GCP, Data Pipelines, Git,
        Jupyter, MNE-Python
...
\entry{Water Body Segmentation with Deep Learning}
      {Kaggle (2024)}
      {Python $\cdot$ PyTorch $\cdot$ U-Net $\cdot$ Computer Vision}
      {\begin{itemize}
        \item Designed and trained a U-Net segmentation model in PyTorch on masked satellite
              imagery, evaluating performance with IoU and F1 scores.
      \end{itemize}}
\vspace{0.5em}
...
\begin{itemize}
  \item \textbf{GSP-Based Spectral Biomarkers for Alzheimer's Detection} --- Coventry CSMM
        Conference (2025), Poster Presentation.
\end{itemize}
